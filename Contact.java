public class Contact {
	...
	protected void updateLastName(String lastName) {
		if (lastName == null) {
			...
			throw new IllegalArgumentException(
					"Last name cannot be longer than " + CONTACT_LNAME_LENGTH + " characters");
		} else {
	...
	protected void updatePhoneNumber(String phoneNumber) {
		...
		if (phoneNumber == null) {
			...
			throw new IllegalArgumentException(
					"Phone number length invalid. Ensure it is " + CONTACT_PHONENUM_LENGTH + " digits.");
	...
	protected void updateAddress(String address) {
		if (address == null) {
			...
			throw new IllegalArgumentException(
					"Address cannot be longer than " + CONTACT_ADDRESS_LENGTH + " characters");
		} else {
